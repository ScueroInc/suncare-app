...
ReqResRespuesta2 reqResRespuesta2FromJson(String str) =>
    ReqResRespuesta2.fromJson(json.decode(str));

String reqResRespuesta2ToJson(ReqResRespuesta2 data) =>
    json.encode(data.toJson());

class ReqResRespuesta2 {
  ReqResRespuesta2({
    this.name,
    this.region,
    this.country,
  ...
  factory ReqResRespuesta2.fromJson(Map<String, dynamic> json) =>
      ReqResRespuesta2(
        name: json["name"],
        region: json["region"],
        country: json["country"],
